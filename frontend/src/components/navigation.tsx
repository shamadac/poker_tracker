...
const navigation = [
  ...
  { name: "Admin", href: "/admin/encyclopedia", adminOnly: true },
        ...
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center space-x-8">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="font-bold text-xl hidden sm:block">Poker Analyzer</span>
              <span className="font-bold text-lg sm:hidden">PA</span>
            </Link>
      ...
      <div className="grid grid-cols-7">
        {navigation.map((item) => (
          <Link
            ...
            href={item.href}
            className={cn(
              "flex flex-col items-center space-y-1 py-3 px-2 text-xs font-medium transition-colors",
              pathname === item.href
                ? "text-primary bg-primary/10"
                : "text-muted-foreground"
            )}
